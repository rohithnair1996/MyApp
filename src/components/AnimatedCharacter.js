...
/**
 * Base animated character component with walking animations
 * Handles both SharedValue positions (from player movement) and regular numbers (from other users)
 */
const AnimatedCharacter = ({ x, y, color, image }) => {
